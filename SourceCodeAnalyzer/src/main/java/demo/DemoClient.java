...
public class DemoClient {
	...
	public static void main(String[] args) throws IOException {
		...
		DivideActivities actvities = new DivideActivities();
		actvities.codeAnalyzer(filepath, sourceCodeAnalyzerType, sourceFileLocation, outputFilePath, outputFileType);
